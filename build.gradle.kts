...
subprojects {
    ...
    aliucord {
        author("コニ", 403125238487056394L)
        updateUrl.set("https://raw.githubusercontent.com/vanir-04/aliuplugins/builds/updater.json")
        buildUrl.set("https://raw.githubusercontent.com/vanir-04/aliuplugins/builds/%s.zip")
    }
